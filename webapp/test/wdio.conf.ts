...
export const config: wdi5Config = {
    ...
    wdi5: {
        ...
        waitForUI5Timeout: 25000, // [optional] {number}, default: 15000; maximum waiting time in milliseconds while checking for UI5 availability
    },
    //
    // ====================
    ...
    autoCompileOpts: {
        ...
        tsNodeOpts: {
            transpileOnly: true,
            project: "./webapp/test/tsconfig.json",
        },
